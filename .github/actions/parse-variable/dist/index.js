...
let dotenv_action = function (dotenvFile) {
    ...
    const dotenv = (__nccwpck_require__(471).config)({ path: dotenvFile });
    const dotenv_expand = (__nccwpck_require__(113).expand)(dotenv);
...
const dotenvAction = __nccwpck_require__(362);
try {
  ...
  core.setOutput('json', JSON.stringify(variables).replaceAll('"','\\"'));
